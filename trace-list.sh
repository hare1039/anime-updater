...
source ${HOME}/Documents/git_projects/mega-trace/dl-func.sh;
# unit test #1: ENOENT
# megadl_from 'https://mega.co.nz/#F!d8RR0RJJ!bdlyZny9iFwJxH2CfXnNTQ';

cd '/mnt/NAS/video/#連載中/童話魔法使';
megadl_from 'https://mega.nz/#F!jRJxVLIL!9F_9oCPOSjp7rX2TKVmx-Q';

cd '/mnt/NAS/video/#連載中/庫洛魔法使 透明牌篇';
megadl_from 'https://mega.nz/#F!2BpmyZRL!69TDyTv13D-Cuns3IPjmUQ' && cd -;
megadl_from 'https://mega.nz/#F!f08B1CRA!ML5OO0ODFM4gbOcWJXSeAQ' && cd -;
megadl_from 'https://mega.nz/#F!25Vh1QKB!-_aNjFO76mgLIeBhNo68SQ';

cd '/mnt/NAS/video/#連載中/粗點心戰爭2';
megadl_from 'https://mega.nz/#F!KZ4l2BiK!hbT4s-Y4e_lCUn-VSag9wg';

cd '/mnt/NAS/video/#連載中/DARLING in the FRANXX'; 
megadl_from 'https://mega.nz/#F!nUZXySwa!3Br1mOuyilFpuDRcVLrapg';

cd '/mnt/NAS/video/#連載中/紫羅蘭永恆花園'; 

cd '/mnt/NAS/video/#連載中/沒有心跳的少女 BEATLESS';
megadl_from 'https://mega.nz/#F!uEg0jK4S!g4j6qzwISKowREGSUEwZQg';

cd '/mnt/NAS/video/#連載中/刀使之巫女';
megadl_from 'https://mega.nz/#F!kaJFALjS!CanZeJjW7LojwVF3FElpyw';

cd '/mnt/NAS/video/#連載中/老子是魔法少女';
megadl_from 'https://mega.nz/#F!TYByiCxI!Zz9RMmEFWB0xFMIRSDKTGQ';

cd '/mnt/NAS/video/#連載中/LOST SONG';
megadl_from 'https://mega.nz/#F!TdoXhJLD!Q88MjXSTybGlYGBajhOs3Q';
...
cd '/mnt/NAS/video/#連載中/黑社會的超能力女兒';
megadl_from 'https://mega.nz/#F!iHYhCBLC!ZxpklNrUn-gJQcb6c49x9Q';
...
# cd '/mnt/NAS/NFS/hare1039/download/[CreamPie]√ハーレム！ Root Harem！';
# megadl_from 'https://mega.co.nz/#!h9RHkDpK!JzBDqWvFoH52OlujucHB6RRM-KZmEr4if1PXYoFwSXY';
# megadl_from 'https://mega.co.nz/#!904wTQ5Q!Le1-QmBUGngY8tzdJLENFU-qtQl_gxU_VBXKTX5_z7A';
# cd '/mnt/NAS/video/hare/戀愛ラボ';
# megadl_from 'https://mega.co.nz/#F!jdZSVRRD!icEhvg_EHxbd5-VY5X_MUA';
# cd '/mnt/NAS/video/hare';
# megadl_from 'https://mega.nz/#!qIgnEYqQ!WNFge7qqDUM3eZweP6OJ44gk-B94hP3CJEV3rLZIEKM';
# cd '/mnt/NAS/video/hare/變態王子與不笑貓';
# megadl_from 'https://mega.co.nz/#F!RsJQwDJL!GbaAtgnnce8Q444oU26YWA';
# cd '/mnt/NAS/video/hare/瀨戶的花嫁';
# megadl_from 'https://mega.co.nz/#F!YBlHGL6Q!6V7jv0fPC4hA9xBKQ-GHFA';
# # 雪花隨風飄散
...
# 
# cd '/mnt/NAS/video/hare/假面男僕';
# megadl_from 'https://mega.co.nz/#F!koUnDZaC!2L2f5_1ss9e0b7pg9x1i_Q'
# 
...
# 
# cd '/mnt/NAS/video/hare/魔法高校的劣等生 呼喚繁星的少女';
# megadl_from 'https://mega.nz/#!HMBUmC7A!hLsC5WCBOXPyPOwvhL2VQXLjEQkX7tAlHrwqqBPuX2s';
...
# 
# megadl_from 'https://mega.nz/#F!cQsGzKBT!vtMWlN8Em31_CxbwZTpgCQ';
# cd '/mnt/NAS/video/#連載中/刻刻';
# megadl_from 'https://mega.nz/#F!fcZDWTgT!789gbiFh7MoZAmw_FAZc2A';
# cd '/mnt/NAS/video/#連載中/搖曳露營';
# megadl_from 'https://mega.nz/#F!7A5VXRYZ!n8IgFYSCcRUWsJ8BDW3pew'; cd -;
# megadl_from 'https://mega.nz/#F!3RAlDKzQ!eO4jmAgNYZcaHjZV0onuNA'; cd -;
# megadl_from 'https://mega.nz/#F!obIDGIDS!dYVW2K96mllB-lAgZ_Bi7A';
# cd '/mnt/NAS/video/#連載中/龍王的工作';
# megadl_from 'https://mega.nz/#F!3Bg02QrL!pQOiI3r7QCoFoxxuvn5Feg';
# cd '/mnt/NAS/video/#連載中/Slow Start';
# #megadl_from 'https://mega.nz/#F!lLIDDSpJ!usGEb7ubIqjVVIIyxeP6bQ'; cd -;
# megadl_from 'https://mega.nz/#F!TBoGARqB!VYZr8VKHTrZmZtcWMo5DMA'; cd -;
# megadl_from 'https://mega.nz/#F!OMBHER6T!e8ei0Xzi4LesibqsAq9F7g';
...
# # megadl_from 'https://mega.nz/#F!8Wo2HI6Q!XFH5fWnOncWIl-q3AETMyA'; cd -;
# megadl_from 'https://mega.nz/#F!iNZwxbAB!ixvGflTukTNuqZe9OI7SeQ';
...
# megadl_from 'https://mega.nz/#F!OQhQlJ5Q!gFuJ8y19pXdRxlzH9fpTIg'; cd -;
...
# cd '/mnt/NAS/video/hare/膽小狗英雄';
# megadl_from 'https://mega.nz/#F!oQ1CSRBJ!dZawDVcUoVOsRJUGDLfrSw';
...
# cd '/mnt/NAS/video/hare/The Rolling Girls';
# megadl_from 'https://mega.co.nz/#F!fcAHkB7Y!Y1OJM7OQU49u77OJJzU11A';
# cd '/mnt/NAS/video/hare/東京闇鴉';
# megadl_from 'https://mega.co.nz/#F!N5lkWToY!V-HfOYur7WkPFo5ZdKFj2A';
